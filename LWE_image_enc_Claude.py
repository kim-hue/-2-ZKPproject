...
def encrypt_image(public_key, image_array, q, t, block_size):
    ...
    for i in range(0, height, block_size):
        for j in range(0, width, block_size):
            block = image_array[i:i+block_size, j:j+block_size].astype(int)
            c1, c2 = encrypt(public_key, block.flatten(), q, t)
...
image_path = "F:/[2]ZKPproject/bit-256-x-256-Grayscale-Lena-Image_Q320.jpg"
